...
Какая может быть зарплата в этой вакансии? Ориентируемся на рынок России. Не нужно развёрнуто отвечать. Интересует только число: примерная зарплата в рублях. После числа используй символ рубля.

Пример того, как оформить результат: 50 000 ₽`;
